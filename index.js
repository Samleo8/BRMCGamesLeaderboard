...
"/newgroup <group name> - Create a new group with name <group name> score 0 [admin]. (Alternatively use '/newgroup' then type names)\n"+
...
bot.on('callback_query', (ctx)=>{
	...
	if(info[0] == "confirm"){
		...
		if(info[1] == "deleteleaderboard"){
			...
			let _info_msg = "Leaderboard in "+leaderboard_title+" has been deleted by "+_getName(ctx.callbackQuery);
			ctx.reply(_info_msg);
